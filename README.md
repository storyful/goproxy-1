...
[![GoDoc](https://godoc.org/github.com/storyful/goproxy-1?status.svg)](https://godoc.org/github.com/storyful/goproxy-1)
[![Join the chat at https://gitter.im/storyful/goproxy-1](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/storyful/goproxy-1?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
![Status](https://github.com/storyful/goproxy-1/workflows/Go/badge.svg)
...
Get the latest goproxy from `gopkg.in/storyful/goproxy-1.v1`.
...
[the eavesdropper example](https://github.com/storyful/goproxy-1/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/storyful/goproxy-1/tree/master/examples/goproxy-transparent)
